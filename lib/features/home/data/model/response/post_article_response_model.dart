class ArticleResponseModel {
  ArticleResponseInfo? article;

  ArticleResponseModel({this.article});

  ArticleResponseModel.fromJson(Map<String, dynamic> json) {
    article = json["article"] == null
        ? null
        : ArticleResponseInfo.fromJson(json["article"]);
  }
...
class ArticleResponseInfo {
  ...
  ArticleResponseInfo.fromJson(Map<String, dynamic> json) {
    slug = json["slug"];
    title = json["title"];
