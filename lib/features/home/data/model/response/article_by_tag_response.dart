...
class ArticleByTag {
  ...
  ArticleByTag({this.articles, this.articlesCount});

  ArticleByTag.fromJson(Map<String, dynamic> json) {
...
class Articles {
  ...
  Articles({this.slug, this.title, this.description, this.body, this.tagList, this.createdAt, this.updatedAt, this.favorited, this.favoritesCount, this.author});
